...
class TransFilePage extends StatefulWidget {
  const TransFilePage({super.key});

  @override
  State<TransFilePage> createState() => _TransFilePageState();
}

class _TransFilePageState extends State<TransFilePage> {
  double progress = 0.0;
  String status = "等待下载...";
